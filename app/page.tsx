    ...
    <main className="mx-auto flex min-h-full max-w-screen-md flex-col justify-between pb-20 pt-6 max-sm:pb-16 max-sm:pt-0 landscape:max-md:pt-0">
      <div className="mb-2 mt-6 flex justify-between p-4 pr-2 max-sm:mt-2 max-sm:pr-2 landscape:max-md:mt-0">
        <div className="flex flex-row text-xl leading-8  max-sm:text-base">
          <div
            className="ml-3 text-5xl font-bold leading-10 max-sm:leading-8"
            style={{
              backgroundImage: 'linear-gradient(to right, #1d4ed8, red)',
            ...
            <div className="text-sm leading-6">
              ...
              {errorMessage !== '' ? (
                ...
                <div
                  ...
                  style={{
                    color: 'blue',
                    backgroundImage: 'linear-gradient(to right, red, #2563eb,#10b981)',
                    WebkitBackgroundClip: 'text',
                    fontSize: '19px',
                    WebkitTextFillColor: 'transparent',
                  }}
